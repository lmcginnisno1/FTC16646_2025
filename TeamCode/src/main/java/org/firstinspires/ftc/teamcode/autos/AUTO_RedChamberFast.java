...
@Autonomous(name = "Red Chamber Fast", preselectTeleOp = "Teleop Red", group = "Auto Red")
public class AUTO_RedChamberFast extends Robot_Auto {
        ...
        return new SequentialCommandGroup(
            new ParallelCommandGroup(
                new SequentialCommandGroup(
                    ...
                    ,new InstantCommand(()-> m_robot.m_intakeSubSlide.setTargetPosition(225))
